...
<head>
    ...
    <style>
        ...
        .terminal { background: var(--card); border: 2px solid #222; border-radius: 15px; padding: 30px; margin: 20px 10px; max-width: 400px; width: 90%; box-shadow: 0 10px 30px rgba(0,0,0,0.5); position: relative; }
...
<body>
    ...
    <div class="terminal">
        ...
        <div class="btn-grid">
            ...
            <button class="btn btn-upgrade" style="background:transparent; border:1px solid #333; color:#666;" onclick="alert('Locked: Requires Smart Contract')">Upgrade Rank</button>
        </div>
    ...
    <div class="roadmap-preview">
        ...
        <p style="color: #888; font-size: 13px; line-height: 1.6;">
            <b>Turbo Multiplier:</b> Integrated logic for exponential cost-scaling upgrades. <br>
            <b>Status:</b> Front-end testing of revenue-sharing math.
        </p>
    </div>
    ...
    <script>
        ...
        function buyMultiplier() {
            if (balance >= multiplierCost) {
                ...
                alert("YIELD DOUBLED! New Daily Rate: " + dailyYield);
            } else {
                alert("Insufficient $BURN for Turbo Multiplier.");
            }
        }
